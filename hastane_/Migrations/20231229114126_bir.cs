    ...
    public partial class bir : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("3e6e7615-d716-4dfd-bbdb-d4c8c661da54"), false, "Ennur", "97CE14A55420C6F332C0A16644B1A47C", "admin", "Gürbüz", "b211210060@sakarya.edu.tr" });

            migrationBuilder.InsertData(
                table: "Poliklinikler",
                columns: new[] { "PoliklinikId", "PoliklinikAdi" },
                values: new object[,]
                {
                    { 1, "Kadın-Doğum" },
                    { 2, "Dahiliye" },
